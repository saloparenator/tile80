...
public class TestGraph {
    ...
    public void testLinkValeur(){
        graph.link("B==D", 69);
        assertEquals(1122400448,graph.hashCode());
    }
    ...
    public void testNeighborAValeurNull(){
        graph.neighborLeft(null);
    }
    @Test
    public void testNeighborAValeurNonExistante(){
        int sum=0;
        for(Integer i : graph.neighborLeft("douze"))
            sum+=i;
        assertEquals(sum,0);
    }
    @Test
    ...
    public void testNeighborBValeur(){
        ...
        List<String> obtenu = new ArrayList<>();
        for (String s : graph.neighborRight(3))
            obtenu.add(s);
    ...
    public void bench(){
        ...
        long b=System.currentTimeMillis();
        for(Integer i : graph.neighborLeft("1333"))
            graph.link("douze", i);
        long c=System.currentTimeMillis();
        for(String s : graph.neighborRight(2333))
            graph.link(s, 12);
